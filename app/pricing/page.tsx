            ...
            >
              <Card className="border-gray-200 h-full flex flex-col">
                ...
                <CardContent className="space-y-4 flex-grow flex flex-col justify-between">
                  ...
                  <Link href={`${user ? `https://t.me/stm_kurs?text=Assalomu alaykum yaxshimisiz. Men ${user.first_name} ${user.first_name} sizning BAZA kursingizni sotib olmoqchiman.` : '/auth'}`} className="block pt-4">
